...
const configDefaults={topic:'',language:'English',content_type:'YouTube Short',duration_minutes:1,duration_seconds:60,tone:'Informative',audience:'General',research_depth:'standard',publish:'manual',schedule:'',pipeline_enabled:true};
let projectRows=[];
let projectChannels=[];
let selected=null;
